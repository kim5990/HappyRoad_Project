...
/**
 * Servlet implementation class SearchplaceNoList
 */
@WebServlet("/placeNoList.sc")
public class SearchplaceNoList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchplaceNoList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (placeTitle == "") { // 검색어 입력 없을시
			...
			listNull = "0";
			pi =  PageInfoController.pageController(0, 1, 5, 5);
			...
			ArrayList<PlaceSelect> pslist = pService.selectSearchList(placeTitle, pi);
