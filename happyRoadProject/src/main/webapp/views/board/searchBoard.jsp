    ...
    <biv >
        ...
        <div class="search-input">
            <div class="left-search-section">
                <input type="text" onkeyup="enter()" name="searchBoard" class="left-section_input" style="background: white;">
                <input type="image" onclick="sera()" src="./resources/logo/free-icon-magnifier-2319177.png" height="17" width="17">
            </div>
        </div>
