                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item ">
                                <a class="nav-link" style="background-color: rgb(255, 255, 255); color:  rgb(81, 126, 165);"
                                    aria-current="page" href="list.fa?cpage=1&userNo=<%=loginUser.getUserNo() %>">즐겨찾기
                                    리스트</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"
                                    style="background-color: rgb(255, 255, 255); color: rgb(81, 126, 165);"
            ...
            <div class="insertForm">
                <div class="text-bg-light p-3 insertFormdiv">
                    <div class="insertFormHeader">
                        ...
                        <br>
                        <form action="placeInsert.ma" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="userNo" value="<%=loginUser.getUserNo()%>">
                            <div class="insertPlace1">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" name="placeTitle"
                                        placeholder="방문지를 쓰세요" required >
                            ...
                            <div class="insertPlace1">
                                <div class="mb-3">
                                    <input type="text" class="form-control" name="placeContentPoint"
                                        id="exampleFormControlInput1" placeholder="한줄 설명" required>
                                </div>
                            </div>
                            <div class="insertPlace1">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1"
                                        name="placeContentDetail" rows="3"></textarea>
                                </div>
                            </div>

                            <div class="insertPlace1">
                                <div class="mb-3">
                                    <input type="text" class="form-control" name="placeAddress"
                                        id="exampleFormControlInput1" required placeholder="예시)서울특별시 강남구 테헤란로14길 6">
                                </div>
                            </div>
                            <div class="insertPlace1">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" name="placeContact" class="form-control"
                            ...
                            <div class="insertPlace1">
                                <div class="row g-2">
                                    <div class="col-md">
                                        <div class="form-floating">
                                            <input type="date" name="placeStart" class="form-control"
                                                id="floatingInputGrid" placeholder="2023-10-01" value="">
                                            <label for="floatingInputGrid">행사시작일</label>
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        <div class="form-floating">
                                            <input type="date" name="placeEnd" class="form-control"
                                                id="floatingInputGrid" placeholder="2023-10-01" value="">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="time" name="endTime" class="form-control"
                                                    id="floatingInputGrid" placeholder="010-xxxx-xxxx" value="">
                            ...
                            <br>
                            <div class="managerPlaceInsertList">
