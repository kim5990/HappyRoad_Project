    ...
    <div class="calender">
        ...
        <div class="paging">
            <div class="paging-controller">
                ...
                <input type="range" class="form-range" onclick = "location.href = '' " id="disabledRange1" disabled >
                <input type="range" class="form-range" onclick = "location.href = '' " id="disabledRange2" disabled >
                <input type="range" class="form-range" onclick = "location.href = '' " id="disabledRange3" disabled >
                <input type="range" class="form-range" onclick = "location.href = '' "id="disabledRange4" disabled>
                <button type="button" onclick = "location.href = '' " class="btn btn-light"><svg xmlns="http://www.w3.org/2000/svg" width="16"
